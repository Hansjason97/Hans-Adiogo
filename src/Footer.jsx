...
function Footer() {
  return (
    <div className=''>
        ...
        lg:left-6'>
            <a href="#" className='footerLink'><VscGithub /></a>
            <a href="#" className='footerLink'><RxLinkedinLogo /></a>
            <a href="#" className='footerLink'><GrInstagram /></a>
            <a href="#" className='footerLink'><FaBehance /></a>
        </div>
        ...
        md:after:content-[""] md:after:block md:after:h-10 md:after:w-[1px] md:after:bg-blancDark
        lg:right-7'>
            <a href="mailto:gviche@krestholding.com" className='footerMail'>gviche@krestholding.com</a>
        </div>
        <div className='flex py-5 justify-center gap-5 font-mono text-sm'>
          <a href="https://github.com/Hansjason97" className='transition-all duration-100 ease-linear hover:text-primary'>2023 - Krest Digital & FinTech</a>
        </div>
    </div>
  )
}
