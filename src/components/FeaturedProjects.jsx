    ...
    <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3 my-6">
      {props.data.map((project, index) => (
        <div key={index} className="mx-auto group cursor-pointer">
          <div
            className="flex flex-col px-5 py-10 relative bg-secondaryDark rounded-md h-full top-0 shadow-sm
                hover:top-[-7px] transition-all duration-150 ease-in"
          >
            <div className="flex justify-between pb-6 items-center z-10">
              ...
              <div className="flex gap-4 items-center">
                {project.linkGithub != null && (
                  <a
                    ...
                    target="_blank"
                    className="hover:text-primary transition-all duration-150 ease-linear"
                  >
